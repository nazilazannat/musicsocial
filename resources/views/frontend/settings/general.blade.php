            ...
            <div class="card-body">
                <form action="{{ url('edit', $users->id) }}" method="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="f_name" value="{{ $users->f_name }}" class="form-control">
                      </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword" class="col-sm-2 col-form-label">Last Name</label>
                        <div class="col-sm-10">
                          <input type="text" name="l_name" value="{{ $users->l_name }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
